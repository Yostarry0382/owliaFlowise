...
import { Box, Card, CardContent, Typography, Chip, LinearProgress, IconButton } from '@mui/material';
...
export default function OwlAgentCard({ agent }: OwlAgentCardProps) {
      ...
      <CardContent sx={{ p: 2.5 }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <VisibilityIcon sx={{ fontSize: 16, color: '#FFD700' }} />
